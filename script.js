 ...
 */
 function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        E.innerHTML=" Good morning, I am Doris";
    } else if (h>=12 && h<18) {
        E.innerHTML+=" Good afternoon, I am Doris";
    } else if (h>=18 && h<20) {
        E.innerHTML=" Good evening, I am Doris";
    } else  {
        E.innerHTML="Good night, I am Doris";
    } }
//  greetingFunc();
...
async function initMap() {
 // The location of CMU
 const position = { lat: 40.4674326897527, lng: -79.96420309006973};
